...
const dasborUkmAktif = () => {
    const ctx = document.getElementById("dasbor-ukm-aktif");
    if (!ctx) return;
    ...
    //     })
    //     .then((result) => {
    //         const activeUkm = result.map((item) => item.total_ukm_aktif);
    //         // const labels = result.map((item) => item.angkatan);
    //         // const data = result.map((item) => item.total_anggota);
    //         console.log(activeUkm);
    ...
    fetch("/ukm-status")
        ...
        .then((result) => {
            const activeUkm = result.total_ukm_aktif;
            const inactiveUkm = result.total_ukm_tidak_aktif;
            const labels = ["Aktif", "Tidak Aktif"];
            const data = [activeUkm, inactiveUkm];
            console.log(data);
            ...
            const chart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [
                        {
                            label: "Perbandingan UKM Aktif dan Tidak Aktif",
                            data: data,
                            backgroundColor: [
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        htmlLegend: {
                            ...
                            containerID: "dasbor-ukm-aktif-legend",
                        },
                    },
                    interaction: {
                        intersect: false,
